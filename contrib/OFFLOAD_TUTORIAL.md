...
At this point you should have a valid build environment to begin code development. See [Appendix A.1](#appendix-a1-shell-file-contents) for a complete version of this shell environment.
